...
WIth Build 17093 and later [[https://docs.microsoft.com/en-us/windows/wsl/wsl-config#set-wsl-launch-settings][certain functionality]] in WSL can be configured inside
the file "/etc/wsl.conf". The default is as follows:
