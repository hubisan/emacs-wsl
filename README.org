...
- Open the settings by clicking on the dropdown button to add a new tab and then
  select settings (bound to @@html:<kbd>@@Ctrl-,@@html:</kbd>@@).
- Copy the GUID for WSL (example: {12345678-1234-1234-1234-1234567890AB}).
- Set the default profile to the one copied from WSL: (example:
  "defaultProfile" : "{12345678-1234-1234-1234-1234567890AB}",)

* Configure WSL

Start the WSL (in Windows Termin if you have installed it) and configure it.
...
**** remark
For the *setxkbmap -layout us* line, make sure you have *x11-xkb-utils* installed
using 
#+BEGIN_SRC shell
sudo apt install x11-xkb-utils.
#+END_SRC

**** Changes needed if using WSL2
